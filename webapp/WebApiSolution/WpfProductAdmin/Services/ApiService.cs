...
namespace WpfProductAdmin.Services
{
    public class ApiService
    {
        ...
        // private readonly string serviceUrl = "http://localhost:5276/api/products"; // 최초 개발용
        private readonly string serviceUrl = "http://192.168.0.4:8080/api/products";    // 도커배포 API
